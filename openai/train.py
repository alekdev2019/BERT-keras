...
from openai.opt import adam, warmup_cosine, warmup_linear, warmup_constant
from openai.datasets import rocstories
from openai.analysis import rocstories as rocstories_analysis
from openai.text_utils import TextEncoder
from openai.utils import encode_dataset, iter_data, find_trainable_variables, convert_gradient_to_tensor, \
